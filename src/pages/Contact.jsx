...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          <BlurFade delay={0.2}>
            <h2 className="text-3xl md:text-5xl font-playfair font-bold text-gray-800 mb-6 max-w-2xl mx-auto leading-tight">
              If You Have Any Query, <br className="hidden md:block" /> Please
              Contact Us
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <BlurFade direction="up" delay={0.5}>
            <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-orange-100">
              <h4 className="text-2xl font-bold text-gray-800 mb-8 font-Montserrat">
                Leave your message
              </h4>
              <form className="space-y-6">
                ...
                ></textarea>
                <Button className="w-full py-5 text-lg font-bold !bg-[#3D0C02] hover:!bg-[#5D1C02] text-white rounded-xl shadow-lg transition-transform active:scale-95">
                  Send Message
                </Button>
              </form>
            </div>
          ...
          <div className="lg:pt-8">
            <BlurFade delay={0.6}>
              <h4 className="text-4xl font-bold text-gray-800 mb-12 font-Montserrat">
                Contact
              </h4>
              <div className="space-y-12">
                ...
                <div className="flex items-center gap-6 group">
                  ...
                  <div>
                    <h5 className="text-xl font-bold text-gray-800 font-Montserrat mb-1">
                      Office
                    </h5>
      ...
      {/* Map Section */}
      <section className="h-[500px] mx-auto max-w-xl p-4 mb-3 rounded-2xl bg-gray-100 relative grayscale hover:grayscale-0 transition-all duration-1000">
        <iframe
          title="Google Map"
          className="w-full rounded-2xl h-full border-none"
